    ...
    <div class="container">
        ...
        <div id=" mainListDiv" class="main_list">
            <ul class="navlinks">
                ...
                <li><a href="${pageContext.request.contextPath}/in/home/shop/plant">Power Plant Shop</a></li>
                <li><a href="${pageContext.request.contextPath}/in/home/logout">Log out</a></li>
            </ul>
        </div>
